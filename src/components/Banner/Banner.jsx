...
const Banner = () => {
  return (
    <div className="px-5 lg:px-0 mt-8 mb-24">
      <Swiper
        rewind={true}
        navigation={true}
        loop={true}
      ...
      >
        <SwiperSlide>
          <div className="w-full lg:h-[540px] rounded-lg hero bg-[url(https://i.ibb.co.com/f0nMk5D/canada.jpg)] bg-cover bg-no-repeat bg-center">
        ...
        <SwiperSlide>
          <div className="w-full lg:h-[540px] rounded-lg hero bg-[url(https://i.ibb.co.com/3rXVfzg/Australia.jpg)] bg-cover bg-no-repeat bg-center">
            <div className="hero-overlay bg-opacity-40 rounded-lg">
              <div className="px-12 lg:px-16 border-0 md:w-3/4 lg:w-1/2 flex flex-col gap-5 justify-center items-start border-black h-screen rounded-lg">
                <h1 className="font-bold uppercase text-4xl md:text-5xl lg:text-7xl text-white">
                Australia
        ...
        <SwiperSlide>
          <div className="w-full lg:h-[540px] rounded-lg hero bg-[url(https://i.ibb.co.com/s99FXcH/germany.jpg)] bg-cover bg-no-repeat bg-center">
            <div className="hero-overlay bg-opacity-40 rounded-lg">
              <div className="px-12 lg:px-16 border-0 md:w-3/4 lg:w-1/2 flex flex-col gap-5 justify-center items-start border-black h-screen rounded-lg">
                <h1 className="font-bold uppercase text-4xl md:text-5xl lg:text-7xl text-white">
                Germany
