      ...
      <footer className="">
        <div className="container px-6 py-8 mx-auto">
          <div className="flex flex-col items-center text-center">
            <Link className="w-auto h-7 text-2xl font-bold uppercase text-green-500">
              World Pass Express
            </Link>
            ...
            <div className="flex flex-wrap justify-center mt-6 -mx-4">
              ...
              <Link
                ...
                className="mx-4 text-sm  transition-colors duration-300 hover:text-green-500  dark:hover:text-green-400"
                aria-label="Reddit"
                data-tooltip-id="cookies-tooltip"
                data-tooltip-content="Cookies"
                data-tooltip-place="bottom-end"
              >
                {" "}
                Cookies{" "}
              </Link>
              <Tooltip id="cookies-tooltip" />
            </div>
          </div>
          ...
          <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div className="flex -mx-2">
              <Link
                to="/"
                className="mx-2 transition-colors duration-300  hover:text-green-500 dark:hover:text-green-400"
                aria-label="Reddit"
              >
                <svg
              ...
              <a
                href="https://github.com/MdAfsarHossain"
                target="_blank"
                className="mx-2  transition-colors duration-300  hover:text-green-500 dark:hover:text-green-400"
                aria-label="Github"
              >
