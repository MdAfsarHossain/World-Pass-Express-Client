...
const Navbar = () => {
  ...
  const dashBoardRoutes = (<>
    {user && (
      <>
        ...
        <li>
          <NavLink to="/requested-visas">Requested Visas</NavLink>
        </li>
      </>
    )}
  </>)
  ...
  return (
    <div className="navbar bg-base-400 border-0 px-2 sticky top-0 z-50 backdrop-blur-3xl">
      <div className="navbar-start">
        ...
        <Link to="/" className="font-bold text-2xl lg:text-3xl">
          World <span className="text-green-500">Pass</span>
        </Link>
      </div>
      ...
      <div className="navbar-end">
        {!user ? (
          ...
          <div className="flex flex-row gap-5 lg:gap-8 justify-start items-center">
            {/* Dashboard */}
            <div className="dropdown dropdown-end">
              <div tabIndex={0} role="button" className="rounded-btn"><RxDashboard className="text-4xl font-bold text-emerald-500" /></div>
              <ul
                tabIndex={0}
