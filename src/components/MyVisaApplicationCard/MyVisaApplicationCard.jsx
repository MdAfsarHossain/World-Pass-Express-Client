  ...
  return (
    ...
    <>
      ...
      <tr key={_id}>
        ...
        <td className="p-3">
          <img src={countryImage} alt={countryImage} className="w-24 h-12 rounded-sm" />
        </td>
        <td className="p-3">{appliedDate}</td>
        <td className="p-3">
          <div className={`px-1 text-center ${selectedVisaType === 'Business visa' && 'bg-green-100'} ${selectedVisaType === 'Medical visa' && 'bg-lime-200'} ${selectedVisaType === 'Student visa' && 'bg-orange-200'} ${selectedVisaType === 'Official visa' && 'bg-amber-200'} ${selectedVisaType === 'Tourist visa' && 'bg-sky-200'} rounded-lg`}>
            <h1 className="font-medium text-base">{selectedVisaType}</h1>
          </div>
        </td>
      ...
      <div data-aos="flip-left" className="shadow-lg rounded-lg hover:scale-105 hidden">
        {/* Image and Location */}
